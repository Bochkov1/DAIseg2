...
def history_archaic(
    ...
    demography.add_population(name="SAMPLE", initial_size=10000, initially_active=False)
    demography.add_population(name="SAMPLE_admixed", initial_size=10000)
    ...
    ts = msprime.sim_ancestry(
        samples=[
            ...
            msprime.SampleSet(n_eu, ploidy=1, population="SAMPLE_admixed"),
            msprime.SampleSet(n, ploidy=1, population='AF'),
            msprime.SampleSet(n_neand, ploidy=1, population="ND1", time=t_neand_samples),
            msprime.SampleSet(n_neand, ploidy=1, population="ND2", time=t_neand_samples)
        ],
        ploidy=1,
